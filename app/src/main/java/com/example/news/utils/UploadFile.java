...
public class UploadFile {
    ...
    private void uploadFile(Uri filePath, final Context context, String storagePath) {
        ...
        if (filePath != null) {
            ...
            StorageReference riversRef = storageReference.child(storagePath + getFileName(context, filePath));
                    ...
                    .addOnSuccessListener(taskSnapshot -> {
                       ...
                       riversRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                               ...
                               link[0] =  uri.toString();
                                Log.e("xx", "onSuccess: "+link[0] );
                            }
                        });

                        fileUploadHelper.fileUploaded(link[0]);
                        //and displaying a success toast
                        fileString = link[0];

                        Toast.makeText(context, R.string.file_uploaded, Toast.LENGTH_SHORT).show();
